...
<!--nav bar-->
	...
	<div class="row">
       <div class="column">
         <a href="ordinary.php"><img src="../images/HF1.jpg" alt="ordinary" style="width:100%"></a><br/>
		<h3 style="text-align:center;">Ordinary Fabrics</h3>
       </div>
      <div class="column">
         <a href="functional.php"><img src="../images/HF2.jpg" alt="functional" style="width:100%"></a><br/>
		 <h3 style="text-align:center;">Functional Fabrics</h3>
      </div>
      <div class="column">
         <a href="hydrophobic.php"><img src="../images/HF3.jpg" alt="hydrophobic" style="width:100%" ></a><br/>
		<h3 style="text-align:center;">Hydrophobic Fabrics</h3>
      </div>
    </div>
