<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$sql1="insert into rdetails (username,email,phoneNumber,referenceNumber,type,reason,date )
		values('$username','$email',$phoneNumber,'$referenceNumber', '$type', '$reason', '$date')";
...
<div class="container">
  <form method="post">
   ...
   <h2>RETURN  OR  EXCHANGE  REQUEST </h2>
    ...
    <input type="text" id="referenceNumber" name="referenceNumber" placeholder="Enter your reference number..."required>
    ...
    <textarea id="reason" name="reason" placeholder="Enter the reason" style="height:200px"required></textarea>
...
<footer>
  <ul class="menu2">
		 <li class = "menu2"> <a href="#">RETURN & EXCHANGE</a> </li>
